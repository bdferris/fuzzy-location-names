...
public class ExceptionInterceptor extends AbstractInterceptor {
  ...
  protected ResponseBean getExceptionAsResponseBean(Exception ex) {
    if (ex instanceof NoSuchStopServiceException
      ...
      return new ResponseBean(ResponseCodes.V1,
          ResponseCodes.RESPONSE_RESOURCE_NOT_FOUND, ex.getMessage(), null);
    else
      return new ResponseBean(ResponseCodes.V1,
          ResponseCodes.RESPONSE_SERVICE_EXCEPTION, ex.getMessage(), null);
  }
